...
separable_array_size = [1,1]
dx = 0.1 # microns
dy = 0.1 # microns
wavelength = 0.85 # microns
simulation_height = (separable_array_size[1])*unit_cell_size+2 # microns
simulation_width = (separable_array_size[0])*unit_cell_size+2 # microns
